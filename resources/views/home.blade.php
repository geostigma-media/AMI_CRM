              ...
              <div class="col-md-12">
                ...
                <div id="tabs">
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">Enviar contrato</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">Enviar correos promocionales</a>
                    </li>
